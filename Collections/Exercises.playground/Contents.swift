...
removed = waitingList.remove(at: 0)
admitted.append(removed)
//: ### Exercise 7
...
dictionary = ["Anchovies": false, "Coconut": true, "Cilantro": false, "Liver": false]
...
var value = presidentialPetsDict.removeValue(forKey: "George Bush")
presidentialPetsDict["George Bush"] = value
print(presidentialPetsDict)
//: ### Exercise 11
...
if let barackObamaDog = presidentialDogs["Barack Obama"] {
    print("Michele Obama walks \(barackObamaDog) every morning.")
} else {
