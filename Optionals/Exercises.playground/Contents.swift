...
if let director = director {
    print("The \(movie)'s director is \(director).")
} else {
    print("Not director found for \(movie).")
}
...
if let artist = artist {
    print("\(artist) is the author of \(painting)")
} else {
    print("No author of \(painting)")
}
//: ### Exercise 6
...
if let parent = childViewController.parent {
    print("Parent property is defined.")
} else {
    print("Parent property undefined.")
}
