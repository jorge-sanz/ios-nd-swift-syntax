...
let yourSentence = "As a \(nounArray[6]), should I bring my \(nounArray[1]) all the time?"
let yourSillySentence = "This \(nounArray[index1]) seems like a \(nounArray[index2])"
//: ### Exercise 2
...
let lottaLikes = "If like, you wanna learn Swift, like, you should build lots of small apps, cuz it's like, a good way to practice.".replacingOccurrences(of: "like", with: "")
//: ### Exercise 7
// Example
...
let doubleNumOfPennies = Double(numOfPennies)
print(NSString(format:"%@%.2f", "$", doubleNumOfPennies * 0.01))
//desired output = "$5.67"
//: # Let or Var?
import UIKit
import Foundation
